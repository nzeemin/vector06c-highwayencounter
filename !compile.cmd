...
@echo Compressing hwyenctitle.bin
...
rem First pass, ZX0 stream sizes are not known yet
@echo Compiling hwyenc0 second pass...
tools\sjasmplus --nologo --msg=war --i8080 hwyenc0.asm --lst=hwyenc0.lst --exp=hwyenc0.exp --raw=hwyenc0.bin -DLZSASIZET=%lzsasizet% -DLZSASIZE1=16000
@if errorlevel 1 goto Failed
dir /-c hwyenc0.bin|findstr /R /C:"hwyenc0.bin"

@echo Compiling hwyenc1...
tools\sjasmplus --nologo --msg=war --i8080 hwyenc1.asm --lst=hwyenc1.lst --raw=hwyenc1.bin
@if errorlevel 1 goto Failed
findstr /B "HwyEnc" hwyenc1.lst
dir /-c hwyenc1.bin|findstr /R /C:"hwyenc1.bin"

@echo Compressing hwyenc1.bin...
...
rem Second pass, now we know ZX0 stream sizes
@echo Compiling hwyenc0 second pass...
tools\sjasmplus --nologo --msg=war --i8080 hwyenc0.asm --lst=hwyenc0.lst --exp=hwyenc0.exp --raw=hwyenc0.bin -DLZSASIZET=%lzsasizet% -DLZSASIZE1=%lzsasize1%
@if errorlevel 1 goto Failed
